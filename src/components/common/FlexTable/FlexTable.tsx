...
const FlexTable: React.FC<UserTableProps> = ({
  ...
  const [checkedRows, setCheckedRows] = useState<Set<string | undefined>>(
    new Set()
  );
  ...
  useEffect(() => {
    if (onSelectionChange) {
      const selectedUuids = Array.from(checkedRows).filter(
                  ...
                  {showCheckbox && (
                    <td>
                      <CustomCheckbox
                        ...
                        onChange={(checked) =>
                          handleRowChecked(row.uuid, checked)
                        }
                      />
                    </td>
                  )}
                    ...
                    .map((col) => {
                      ...
                      if (col.key === "username" && showAvatar) {
                        return (
                          <td key={col.key}>
                            <div
                              className="scl--avatar-container"
                              style={{
                                color: col.textColor,
                                cursor: "pointer",
                              }}
                        ...
                        >
                          <ul>
                            <li onClick={() => actionCell?.view?.(row.uuid)}>
                              ...
                              <span className="scl--popup-text-color">
                                View
                              </span>
                            </li>

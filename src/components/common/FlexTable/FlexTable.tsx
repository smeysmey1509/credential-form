...
export interface UserData {
    ...
    profile?: string | null;
    isActive?: 'ACTIVE' | 'DEACTIVATE' | 'ONHOLD' | 'PENDING';
    mfa?: boolean;
    createdAt?: string;
    updatedAt?: string;
}
    ...
    return (
        <div className="scl--table-container">
            <table className="scl--flex-table">
                <thead>
                <tr>
                    {showCheckbox && <th><input type="checkbox"/></th>}
                    ...
                    <tr key={row.uuid || index}>
                                ...
                                return (
                                    <td key={col.key}>
                                        <span
                                            ...
                                            style={{
                                                width: "fit-content",
                                                backgroundColor: statusColorMap[String(value)] || '#6B7280',
                                            }}
                                        >
                        ...
                        {showAction && (
                            <td className="scl--action-cell">
                                <span onClick={() => handleShowActionCell(row.uuid || row.id || index)}>
                                ...
                                {actionCellId === (row.uuid || row.id || index) && (
                                    <div className={`scl--popup-menu`} ref={actionRef}>
                                        <ul>
                                            <li>
                                                <svg width="12" height="10" viewBox="0 0 12 10" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#171717" stroke-opacity="0.6"/>
                                                    <path

  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <div
        ...
        className="flex flex-wrap items-start content-start gap-2 mt-2 border border-[#dee7f1] dark:border-gray-700 rounded font-normal text-[13px] px-[0.75rem] py-[6px] bg-white dark:bg-[#19191C] cursor-pointer focus-within:border-gray-500 transition min-h-[38px]"
      >
        {selected.length === 0 ? (
          ...
          selected.map((item, index) => (
            <div
              key={index}
              className="flex items-center bg-[#5c67f7] rounded [padding-inline:8px] text-sm font-medium text-white"
            >
              {item}
              <button
                type="button"
      ...
      {isOpen && (
        <div className="absolute z-10 w-full border bg-white border-gray-300 dark:bg-[#19191C] dark:border-gray-700 rounded shadow-lg">
          <input
            type="text"

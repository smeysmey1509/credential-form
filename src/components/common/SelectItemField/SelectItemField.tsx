...
const CustomSelect: React.FC<CustomSelectProps> = ({
    ...
    return (
        <div ref={containerRef} className="relative w-full">
            ...
            {isOpen && (
                <div
                    className="absolute z-10 w-full border border-gray-300 bg-white dark:bg-[#19191C] dark:border-gray-700 shadow-lg">
                    <input
                        type="text"
                        placeholder="Search"
                        value={searchTerm}
                            ...
                            filteredOptions.map((option, index) => (
                                <li
                                    ...
                                    className={`px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-[#5c67f7] cursor-pointer ${
                                        selectedOption?.value === option.value ? "bg-gray-100 dark:bg-[#5c67f7]" : ""
                                    }`}
                                    role="option"

...
const SummaryCard = () => {
  return (
    <div className="w-full h-fit flex items-center">
      <span className="w-[3rem] h-[3rem] leading-[3rem] bg-[#F9F9FA] flex justify-center items-center rounded">
        <img
      ...
      <div className="flex-[1_1_auto] flex-col items-center justify-between ml-2">
        ...
        <p className="font-medium text-[0.75rem] font-sans text-[#6e829f]">
          Quantity : 2{" "}
      ...
      <div className="w-fit h-full flex flex-col justify-between items-end">
        <p className="font-semibold font-sans text-[#6e829f] cursor-pointer">
          <IoCloseOutline />
        </p>
        <p className="font-semibold text-[14px] font-sans text-[#212B37]">
          $189
          <s className="font-medium ms-1 text-[11px] font-sans text-[#6e829f]">
            $329
          </s>{" "}
        </p>
      </div>
